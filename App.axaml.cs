...
namespace EasySave
{
    ...
    public partial class App : Application
    {
        ...
        public override async void OnFrameworkInitializationCompleted()
        {
            ...
            {
                // Configuration du container d'injection de d�pendances
                var services = new ServiceCollection();
                ConfigureServices(services);
                var serviceProvider = services.BuildServiceProvider();

                // R�cup�ration et initialisation du MainViewModel via DI
                ...
                // R�cup�ration des chemins dynamiques depuis le backupViewModel
                ...
                // Configuration et affichage de la fen�tre principale
